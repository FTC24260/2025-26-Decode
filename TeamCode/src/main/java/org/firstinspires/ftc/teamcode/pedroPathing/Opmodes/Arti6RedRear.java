...
@Autonomous(name = "6 Red Rear")
public class Arti6RedRear extends OpMode {
    ...
    private Pose startPose = new Pose(81, 9, Math.toRadians(0));
    private Pose p110 = new Pose(124, 9, Math.toRadians(0));
    private Pose p115 = new Pose(129, 9, Math.toRadians(0));
    private Pose p120 = new Pose(134, 9, Math.toRadians(0));
    ...
    public void start() {
        ...
        preloadTimer = System.currentTimeMillis() + 3000; // ONLY for preload
    }
